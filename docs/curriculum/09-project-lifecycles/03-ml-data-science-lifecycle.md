...
[^7]: [Meet Michelangelo: Uber's Machine Learning Platform](https://www.uber.com/blog/michelangelo-machine-learning-platform/) — Hermann & Del Balso, Uber Engineering (centralized Feature Store + a DSL applied identically at training and prediction time to guarantee train/serve consistency and prevent training-serving skew)
[^8]: [Data Validation for Machine Learning](https://research.google/pubs/data-validation-for-machine-learning/) — Breck, Zinkevich, Polyzotis, Whang, Roy (Google), SysML 2019 (distribution-anomaly detection on production feature data and training-serving skew detection; the institutional basis for unsupervised drift proxies like KS / PSI)
